...
#returns a snpset
make_snpset<-function(vcf, ld.threshold=0.2){{}
  vcf.fn <- vcf
  
  # Reformat
  snpgdsVCF2GDS(vcf.fn, "/ebio/abt6_projects9/pathodopsis_microbiomes/data/plant_genotype/test.gds", method="biallelic.only")
  ...
  snpset <- snpgdsLDpruning(genofile, ld.threshold)
  return(snpset)
}
